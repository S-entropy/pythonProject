...
if menu == '회원가입':
    ...
    # 컬럼 레이아웃 생성
    ucol1, ucol2 = st.columns([6, 6]) # st.columns(2)와 같음 / 6, 6 : 비율 -> 그리드 시스템 표준이 12라서.
    ...
    with ucol1: # 첫번째 칼럼
        ...
        # 회원가입 입력 폼 시작
        # st.form과 submit을 쌍으로!
        # clear_on_submit : submit 이후 모두 지움
    ...
    with ucol2:  # 두번째 칼럼
        ...
        def delete_user(*args, **kargs): # streamlit에서 on_click에 args, kargs 모두 요구.
